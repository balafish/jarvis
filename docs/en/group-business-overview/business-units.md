...
2. Content delivery and edge computing (CDN, Edge Compute)
3. Streaming services (Live Streaming, Low Latency Streaming)
4. Cloud security protection (Anti-DDoS, WAF, Bot Management)
5. Professional technical services (Cloud Migration, DevOps, SOC)

**Main Business Items**

| Business Item | Description |
|---------------|-------------|
| Compute | Cloud computing, hosting, VPS, AI services |
| Edge Delivery | CDN, edge computing |
| Streaming | Live streaming, low latency streaming, real-time communication |
| Cloud Security | DDoS protection, WAF, bot management, API protection |
| Professional Services | Cloud migration, Kubernetes, DevOps, security services |
...
- Target headcount: 15 people (by end of 2026)
...
2. Develop financial and payment systems
3. Develop automation programs
...
2. Develop AI operations system (AI SRE)
3. Develop AI digital dealer (AI Dealer)
